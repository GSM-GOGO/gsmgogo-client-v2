          ...
          <S.ContainerResponse>
            ...
            <S.ContainerResponse>
              <S.SubjectContainer>
                ...
                <S.SubjectBox>
                  {eventArr.map((item) => (
                    <S.SubjectOne onClick={() => handleSportSelection(item)} selectedSport={selectedSport === item}>
              ...
              {selectedSport !== "일반경기" ? (
                <>
                  <S.TeamInputContainer>
                    ...
                    <S.TeamInputBox>
                      <S.TeamInput type="text" placeholder="팀 이름은 최대 7글자 입니다" value={teamName} onChange={handleTeamNameChange} />
              ...
              >
                <S.FormationBtn
                  ...
                  onClick={goSports}
                  style={{
                    backgroundColor: selectedMembers.length === MAX_MEMBERS[selectedSport] && teamName !== "" ? "var(--Main, #23F69A)" : undefined,
                    cursor: selectedMembers.length === MAX_MEMBERS[selectedSport] && teamName !== "" ? "pointer" : "not-allowed",
                  }}
                >
                  <S.FormationText
                    style={{
                      color: selectedMembers.length === MAX_MEMBERS[selectedSport] && teamName !== "" ? "var(--Black, #1C1C1F)" : "undefined",
                    }}
                  >
