        ...
        <>
          ...
          >
            <S.MainContainer>
              <S.EventContainer>
                {getEventText()}
                <S.EventTexts style={{ color: '#FFF' }}>{SportsName}</S.EventTexts>
              </S.EventContainer>
              ...
              <S.GradeBox>
                <S.OneGrade>
                  <S.ForMedia>
                    {isFavorite[0] ? (
                      <S.TeamName style={{ color: 'var(--Main, #23F69A)' }}>{TeamName[0]}</S.TeamName>
                    ) : (
                      <S.TeamName style={{ color: '#FFF' }}>{TeamName[0]}</S.TeamName>
                    )}
                  </S.ForMedia>
                ...
                <S.OneGrade>
                  <S.ForMedia>
                    {isFavorite[1] ? (
                      <S.TeamName style={{ color: 'var(--Main, #23F69A)' }}>{TeamName[1]}</S.TeamName>
                    ) : (
                      <S.TeamName style={{ color: '#FFF' }}>{TeamName[1]}</S.TeamName>
                    )}
                  </S.ForMedia>
